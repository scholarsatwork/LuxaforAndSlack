...
function cliCredsCheck() {
  var credCheckStatus = 'starting a credential check';
  console.log(credCheckStatus);
  d.c(credCheckStatus);
  return new Promise((resolve) => {
    ...
    if (missingCreds.length > 0) {
      var getCredStatus = 'getting credentials from user';
      console.log(getCredStatus);
      d.c(getCredStatus);
      ...
      var credStatus = 'already has all credentials';
